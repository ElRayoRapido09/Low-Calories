...
MIDDLEWARE = [
    'lowcalories.simple_cors.SimpleCorsMiddleware',  # Middleware CORS personalizado
    'django.middleware.security.SecurityMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',
    # CSRF deshabilitado para APIs - las vistas usan AllowAny
...
# Configuración CORS - Permitir todos los orígenes para debug
CORS_ALLOW_ALL_ORIGINS = True
CORS_ALLOW_CREDENTIALS = False  # No permitir credenciales cuando se usa ALLOW_ALL
